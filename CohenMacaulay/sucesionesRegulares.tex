...
donde la función $\delta$ es el "homomorfismo que conecta". Para explicar este homomorfismo nos apoyaremos en el siguiente diagrama:

\[
\begin{tikzcd}[ampersand replacement=\&]
\& 0 \ar{d} \& 0 \ar{d} \\
0 \ar{r}{i^0} \ar{d} \& R \ar{r}{p^0} \ar{d}{
\left( \begin{smallmatrix} y \\ x \end{smallmatrix} \right)
} \& R \ar{d}{x} \\
R \ar{r}{i^1} \ar{d}{-x} \& R \oplus R \ar{r}{p^1} \ar{d}{
\left( \begin{smallmatrix} -x & y \end{smallmatrix} \right)
} \& R \ar{d} \\
R \ar{r}{i^2} \ar{d} \& R \ar{r}{p^2} \ar{d} \& R \\
0 \& 0  
\end{tikzcd}
\]

Donde $i^1(z) = \left(\begin{smallmatrix} z \\ 0 \end{smallmatrix} \right)$, $p_1$ es la proyección de la segunda coordenada, $i^0$ es la función trivial y $p^0, i^2, p^2$ son $id_{R}$. 